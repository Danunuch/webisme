				...
				<div class="col-lg-10">
					<div class="box-form">
											...
											<div class="row">
												<div class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
													<div class="input-group">
														...
														<input type="text" class="form-control" value="Spa Beauty">
													</div>
												</div>
										...
										<div class="col-lg-10 col-md-9 col-sm-12 col-xs-12">
											<div class="input-group">
												...
												<select class="form-control" id="sel1">
													<option>1ปี - ราคา 20,000 บาท</option>
													<option>2ปี - ราคา 12,500 บาท</option>
												</select>
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
											<input type="text" class="form-control" id="usr" placeholder="www.domainname.com">
										</div>
									</div>
								</div>
							</div>
						...
						<center>
							...
							<br>
							<div class="checkbox">
								<label><input type="checkbox" value=""> ยอมรับ <a href="#myModal" title="ข้อตกลง ของเว็บไซต์ cw.in.th" data-toggle="modal" data-target="#myModal">ข้อตกลง</a> ของเว็บไซต์ cw.in.th</label>
							</div>
							<br>
							<a class="btn btn-danger" href="">สมัครเปิดใช้งาน</a>
						</center>
					</div>
				</div>
			</div>
