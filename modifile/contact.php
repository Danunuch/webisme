...
<body>
	...
	<section id="section-contact">
		<div class="container">
			...
			<br>
			<div class="row">	
			<form name="sendmail" method="post" action="<?=url('sendcontact')?>">
			<input type="hidden" name="_token" id="csrf_token" value="<?=csrf_token()?>">
				<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
										<input type="text"  name="mobie" class="form-control" id="usr" required>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
										<input type="text"  name="message"  class="form-control" id="usr" required>
									</div>
								</div>
							</div>
						</div>
					...
					<center>
						...
						<br>
						<br>
						<button type="submit" id="submit" disabled class="btn btn-danger"  >ติดต่อทีมงาน</button>
					</center>
				</div>
				</form>
...
<br>
<div class="col-xs-12">
	<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1936.556783275055!2d100.622214!3d13.892157!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x6fb44395301d89f!2scw.in.th!5e0!3m2!1sen!2sth!4v1559273988600!5m2!1sen!2sth" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
