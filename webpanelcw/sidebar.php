    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-center align-items-center">
                <div class="logo mt-4">
                    <a href="home"><img src="../images/logo.png" alt="Logo" style="width: 150px; height: 140px;"></a>
                </div>
                <!-- <span style="font-size:40px; color: red; ">ACE SYSTEM</span> -->
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  service" id="service">
                ...
                <li class="sidebar-item  website" id="website">
                    <a href="website" class='sidebar-link'>
                        <i class="bi bi-browser-chrome"></i>
                        <span>เว็บไซต์สำเร็จรูป</span>
                    </a>
                </li>



                <li class="sidebar-item  portfolio" id="portfolio">
                ...
                <li class="sidebar-item  contact" id="contact">
                ...
                <li class="sidebar-item  ">
                    <a href="logout" onclick="return confirm('คุณต้องการออกจากระบบใช่หรือไม่?')" class='sidebar-link'>
